...
class User(UserMixin, db.Model):
    ...
    # Create Parent Relationship to the BlogPost object
    posts = relationship("BlogPost", back_populates="author")
    # Create Parent Relationship to the Comment object
...
class BlogPost(db.Model):
    ...
    # Create Child Relationship to the User object
...
class Comment(db.Model):
    ...
    # Create Child Relationship to the BlogPost object
